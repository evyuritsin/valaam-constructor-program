const HotelRoom = {
	template: /*html*/ `
							<div class="placement-item" :class="[isSelectRoom && 'placement-item_selected']">
									<div class="placement-item__gallery slider-for">
										<img
									...
									<div class="placement-item__geo">
										<div class="icon-list pt-0">
											...
											<span class="icon-list__label while"
												>Дом паломника «Валаам»</span
											>
										</div>
									</div>
									...
									<div class="placement-item__desc">
										Доступно дополнительное спальное место. Уютные тёплые номера
										(на 2-х гостей) с удобствами в номере. В номере имеются:
										чайник, чашки, чайные ложки, плечики для одежды, полотенца.
										Доступно дополнительное спальное место. Уютные тёплые номера
										(на 2-х гостей) с удобствами в номере. В номере имеются:
										чайник, чашки, чайные ложки, плечики для одежды, полотенца.
									</div>
									<div class="placement-item__prices">
										...
										<div class="placement-item__price">
											<span class="placement-item__value">{{room.price}}</span>
											₽
										</div>
									</div>
									<div
									...
									<div class="placement-item__included">
										<img
											src="./img/icons-svg/wifi.svg"
											alt=""
											class="placement-item__icon"
										/>
										<img
											src="./img/icons-svg/shower.svg"
											alt=""
											class="placement-item__icon"
										/>
										<img
											src="./img/icons-svg/airconditioner.svg"
											alt=""
											class="placement-item__icon"
										/>
										<img
											src="./img/icons-svg/kettle.svg"
											alt=""
											class="placement-item__icon"
										/>
										<img
											src="./img/icons-svg/hanger.svg"
											alt=""
											class="placement-item__icon"
										/>
									</div>
